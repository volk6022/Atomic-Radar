...
PUBLIC_V1 = replace(cascade.DM_V1, key="public_v1", title="Публичные ответы",
...
def test_each_profile_reads_only_its_own_answer():
    ...
    answers = {"dm_v1": {"real_problem": True, "is_seller": False,
               ...
               "public_v1": {"real_problem": True, "is_seller": True,
                             "answering_someone_else": False}}
    ...
    # Один и тот же профиль, одно и то же сообщение — разошлись ровно потому, что
    # ответы получены разными вопросами.
