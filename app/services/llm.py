...
PUBLIC_SYSTEM = (
    ...
    "рекламу.\n\n"
    "Тема, в которой мы можем ответить по делу: хостинг, VPS, VPN, серверы, панели "
    "управления, домены, сети, настройка и перенос инфраструктуры.\n\n"
...
PUBLIC_V1 = Prompt(key="public_v1", version="l3-public-v1", system=PUBLIC_SYSTEM)
