...
def prompt_keys() -> list[str]:
    """Все ключи реестра — для витрин, показывающих не один активный контур, а всё,
    что вообще может спросить модель. Алфавитный порядок, а не порядок объявления:
    список читает человек, и устойчивая сортировка для него полезнее хронологии
    импорта модуля.
    """
